...
with header:
    ...
    st.markdown('  ')
    st.markdown('  ')
    st.markdown('Note: This algorithm is specifically meant to screen untested individuals (i.e individuals who have not done RBS, HbA1c blood tests) to check for the presence of diabetes based on symptoms associated with chronic hyperglycemia ( seen in undiagnosed, untreated individuals).')
